    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(blank=True, choices=[('Passed', 'Passed'), ('Rejected', 'Rejected'), ('On the Floor', 'On the Floor'), ('In Commitee', 'In committee')], db_column='Status')),
                ...
                ('chamber', models.CharField(blank=True, choices=[('Senate', 'Senate'), ('House', 'House of Representatives')], db_column='Chamber', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliation', models.TextField(blank=True, choices=[('Democrat', 'Democrat'), ('Republican', 'Republican'), ('Independent', 'Independent'), ('Other', 'Other')], db_column='Affiliation', null=True)),
                ('district', models.IntegerField(blank=True, db_column='District', null=True)),
        ...
        migrations.CreateModel(
            name='Match',
            fields=[
                ('MID', models.UUIDField(db_column='MID', default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('match_percentage', models.DecimalField(db_column='Percentage', decimal_places=4, default=0, max_digits=6)),
        ...
        migrations.AddField(
            model_name='user',
            name='matched',
            field=models.ManyToManyField(blank=True, related_name='matched', to='votetrackr_api.Match'),
        ),
        migrations.AddField(
            model_name='user',
            name='unvoted',
            field=models.ManyToManyField(blank=True, related_name='unvoted', to='votetrackr_api.Bill'),
        ),
        migrations.AddField(
            model_name='user',
